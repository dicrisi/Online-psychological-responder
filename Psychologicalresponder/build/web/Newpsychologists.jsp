...
if (request.getParameter("register")!=null)
    ...
    String a6=request.getParameter("email_id");
     String a7=request.getParameter("qua");

   // out.println(uid);
int i=0;
      i= st.executeUpdate("insert into psychologiststbl values('"+ a1 +"','"+ a2 +"','"+ a3 +"','"+ a4 +"','"+ a5 +"','"+ a6 +"','"+ a7 +"','Pending')");
     if (i==1)
    {
...
<tr>
		<td class="col">Qualification</td>
		<td><input type="text" name="qua" value="" class="required email" required="" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td >
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Psychologistslogin.jsp">BACK</a>
	</form>
	</div>
</div
     </div>
