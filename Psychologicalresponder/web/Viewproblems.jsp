...
<% Class.forName("com.mysql.jdbc.Driver");
  ...
  Statement st=con1.createStatement();
     ...
     ResultSet resultset = st.executeQuery("select * from postproblem where psychologistid='"+ session.getAttribute("uid") +"'") ;
...
<div class="a-grid">
	...
	<h2> Problems From Users </h2>
		...
		<td bgcolor=white><font color=#000000 size=2><%= resultset.getString(6) %></font></td>
		  ...
		  <td bgcolor=white><font color=#000000 size=2><a href="Updateresponse.jsp?select=<%= resultset.getString(1) %>">Select</a></font></td>
 		</tr>
